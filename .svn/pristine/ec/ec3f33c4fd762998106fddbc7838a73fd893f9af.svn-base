...
namespace Assets.Scripts.Framework
{
	public struct FrameCommand<T> : IFrameCommand where T : struct, ICommandImplement
	{
		...
		public void Send()
		{
			...
			{
				this.playerID = Singleton<GamePlayerCenter>.get_instance().HostPlayerId;
				Singleton<FrameWindow>.GetInstance().SendGameCmd(this, Singleton<LobbyLogic>.get_instance().inMultiGame);
			}
		}
	}
}
