...
namespace Assets.Scripts.GameSystem
{
	public class CAchieveShareComponent
	{
		...
		private void RefreshData(uint achievementId)
		{
			this.ResetData();
			CAchieveInfo2 masterAchieveInfo = CAchieveInfo2.GetMasterAchieveInfo();
			this.m_curAchieveItem = masterAchieveInfo.m_AchiveItemDic.get_Item(achievementId);
			...
			{
				CAchieveItem2 cAchieveItem = masterAchieveInfo.m_AchiveItemDic.get_Item(masterAchieveInfo.MostLatelyDoneAchievements.get_Item(i));
		...
		private void RefreshShareForm()
		{
			...
			{
				component5.SetSprite(masterAchieveInfo.LastDoneTrophyRewardInfo.GetTrophyImagePath(), this.m_shareForm, true, false, false, false);
			}
