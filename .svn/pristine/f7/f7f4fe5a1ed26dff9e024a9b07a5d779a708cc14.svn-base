...
public class LogicTimer 
{
    ...
    public LogicTimer(float _timeStep = 0, int _repeatCount = -1)
    {
        this.time = 0;
        this.currentCount = 0;
    ...
    public void Start()
    {
        ...
        this.time = 0;
        EventDispatcher.AddEventListener(EventsConst.FrameWork.LogicUpdate, this.OnEnterFrame);
    }
    ...
    public void Stop()
    {
        EventDispatcher.RemoveEventListener(EventsConst.FrameWork.LogicUpdate, this.OnEnterFrame);
