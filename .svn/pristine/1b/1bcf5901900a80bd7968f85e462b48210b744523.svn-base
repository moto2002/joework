...
namespace Assets.Scripts.GameLogic
{
	public class GameInput : Singleton<GameInput>
	{
		...
		{
			Singleton<GameEventSys>.get_instance().AddEventHandler<DefaultGameEventParam>(GameEventDef.Event_ActorClearMove, new RefAction<DefaultGameEventParam>(this.OnHostActorClearMove));
		...
		{
			if (this.inputMode.get_tarState() != null)
			{
				((GameInputMode)this.inputMode.get_tarState()).Update();
			}
		...
		{
			((GameInputMode)this.inputMode.get_tarState()).StopInput();
		}
