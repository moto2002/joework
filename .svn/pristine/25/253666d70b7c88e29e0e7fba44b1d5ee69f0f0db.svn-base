...
{
	public class SCPKG_GUILD_CROSS_WEEK_NTF : ProtocolObject
	{
		...
		{
			if (cutVer == 0u || SCPKG_GUILD_CROSS_WEEK_NTF.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GUILD_CROSS_WEEK_NTF.CURRVERSION;
			}
			if (SCPKG_GUILD_CROSS_WEEK_NTF.BASEVERSION > cutVer)
			{
				return TdrError.ErrorType.TDR_ERR_CUTVER_TOO_SMALL;
			}
			TdrError.ErrorType errorType = destBuf.writeUInt32(this.dwCoinPool);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = srcBuf.readUInt32(ref this.dwCoinPool);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_GUILD_CROSS_WEEK_NTF.CLASS_ID;
		}
