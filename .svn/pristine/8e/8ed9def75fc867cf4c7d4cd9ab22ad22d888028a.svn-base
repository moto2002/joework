...
namespace Assets.Scripts.GameLogic
{
	...
	public struct PlayAttackTargetModeCommand : ICommandImplement
	{
		...
		public static IFrameCommand Creator(ref FRAME_CMD_PKG msg)
		{
			...
			frameCommand.cmdData.AttackTargetMode = msg.stCmdInfo.get_stCmdPlayerAttackTargetMode().chAttackTargetMode;
			return frameCommand;
		}

		public bool TransProtocol(FRAME_CMD_PKG msg)
		{
			msg.stCmdInfo.get_stCmdPlayerAttackTargetMode().chAttackTargetMode = this.AttackTargetMode;
			return true;
		}
