...
namespace Assets.Scripts.GameLogic
{
	public class SkillBean
	{
		...
		public void Init()
		{
			...
			if (this._skillSlot.Actor.get_handle().TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Hero)
			{
				ResHeroCfgInfo dataByKey = GameDataMgr.heroDatabin.GetDataByKey((long)this._skillSlot.Actor.get_handle().TheActorMeta.ConfigId);
		...
		public void UpdateLogic(int delta)
		{
			...
			if (!this._skillSlot.Actor.get_handle().ActorControl.IsDeadState && this.BeanAmount < this.upperLimit)
			{
