...
namespace Assets.Scripts.GameSystem
{
	public class SoldierWave
	{
		...
		public void Init(GameObject obj)
		{
			...
			Singleton<GameEventSys>.get_instance().AddEventHandler<SoldierWaveParam>(GameEventDef.Event_SoldierWaveNext, new RefAction<SoldierWaveParam>(this.OnNextWave));
			Singleton<GameEventSys>.get_instance().AddEventHandler<SoldierWaveParam>(GameEventDef.Event_SoldierWaveNextRepeat, new RefAction<SoldierWaveParam>(this.OnNextRepeat));
		}

		public void Clear()
		{
			Singleton<GameEventSys>.get_instance().RmvEventHandler<SoldierWaveParam>(GameEventDef.Event_SoldierWaveNextRepeat, new RefAction<SoldierWaveParam>(this.OnNextRepeat));
			Singleton<GameEventSys>.get_instance().RmvEventHandler<SoldierWaveParam>(GameEventDef.Event_SoldierWaveNext, new RefAction<SoldierWaveParam>(this.OnNextWave));
			this._totalWave = 0;
			this._currentWave = 0;
			this._countdown = 0;
		}
