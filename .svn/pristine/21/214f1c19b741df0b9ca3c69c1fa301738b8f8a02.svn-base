...
namespace Assets.Scripts.Framework
{
	...
	public class GameFramework : MonoSingleton<GameFramework>
	{
		...
		{
			GameFramework.<PrepareGameSystem>c__Iterator1 <PrepareGameSystem>c__Iterator = new GameFramework.<PrepareGameSystem>c__Iterator1();
		...
		{
			GameFramework.<SGame_WaitForTargetFrameRate>c__Iterator2 <SGame_WaitForTargetFrameRate>c__Iterator = new GameFramework.<SGame_WaitForTargetFrameRate>c__Iterator2();
		...
		private void OnApplicationFocus(bool focus)
		{
			if (focus)
			{
				Singleton<CSoundManager>.get_instance().PostEvent("All_Resume", null);
			}
			else
			{
				Singleton<CSoundManager>.get_instance().PostEvent("All_Pause", null);
			}
		}
	}
}
