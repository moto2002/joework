...
{
	public class COMDT_INTIMACY_RELATION : ProtocolObject
	{
		public ulong ullUid;
		...
		{
			if (cutVer == 0u || COMDT_INTIMACY_RELATION.CURRVERSION < cutVer)
			{
				cutVer = COMDT_INTIMACY_RELATION.CURRVERSION;
			}
			if (COMDT_INTIMACY_RELATION.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_INTIMACY_RELATION.CLASS_ID;
		}
