...
namespace Assets.Scripts.GameSystem
{
	public abstract class ActivityView
	{
		...
		public int WidgetCount
		{
			get
			{
				return this._widgetList.get_Count();
			}
		}
		...
		public void Update()
		{
			...
			{
				this._widgetList.get_Item(i).Update();
			}
		}
		...
		public void ExcludeShow(ActivityWidget theOne)
		{
			for (int i = 0; i < this._widgetList.get_Count(); i++)
			{
				this._widgetList.get_Item(i).root.CustomSetActive(theOne == this._widgetList.get_Item(i));
			}
		}
		...
		public void RestoreShow()
		{
			for (int i = 0; i < this._widgetList.get_Count(); i++)
			{
				this._widgetList.get_Item(i).root.CustomSetActive(true);
			}
		}
	}
}
