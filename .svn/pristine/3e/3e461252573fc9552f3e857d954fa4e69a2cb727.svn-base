...
namespace Assets.Scripts.GameSystem
{
	public class ScoreboardPvE
	{
		...
		private int CalcCurrentTime()
		{
			...
			if (curLvelContext != null && curLvelContext.m_isShowTrainingHelper && Singleton<BattleLogic>.get_instance().dynamicProperty != null)
			{
				num = (int)Singleton<BattleLogic>.get_instance().dynamicProperty.m_frameTimer;
			}
