...
namespace Assets.Scripts.GameLogic
{
	...
	internal class StarConditionMonsterTrigger : StarCondition
	{
		...
		public override void Initialize(ResDT_ConditionInfo InConditionInfo)
		{
			...
			this.TriggerCount = 0;
			Singleton<TriggerEventSys>.get_instance().OnActorEnter += new TriggerEventDelegate(this.OnActorEnter);
			Singleton<TriggerEventSys>.get_instance().OnActorLeave += new TriggerEventDelegate(this.OnActorLeave);
