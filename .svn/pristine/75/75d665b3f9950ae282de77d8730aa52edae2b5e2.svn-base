...
namespace Assets.Scripts.GameSystem
{
	...
	public class CPlayerPvpInfoController : Singleton<CPlayerPvpInfoController>
	{
		...
		private static int CacheSubTab
		{
			get
			{
				return PlayerPrefs.GetInt(string.Format(CPlayerPvpInfoController.sCacheSubTabStr, Singleton<CRoleInfoManager>.get_instance().GetMasterRoleInfo().playerUllUID.ToString()));
			}
			set
			{
				PlayerPrefs.SetInt(string.Format(CPlayerPvpInfoController.sCacheSubTabStr, Singleton<CRoleInfoManager>.get_instance().GetMasterRoleInfo().playerUllUID.ToString()), value);
			}
		}
		...
		public override void Init()
		{
			...
			{
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_1"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_2")
			};
			CPlayerPvpInfoController.sSubTitles = new string[]
			{
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_3"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_4"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_5"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_6"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_7"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_8"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_9")
			};
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Pvp_MainList_Click, new CUIEventManager.OnUIEventHandler(this.OnMainListClick));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Pvp_SubList_Click, new CUIEventManager.OnUIEventHandler(this.OnSubListClick));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Pvp_SubList_Show, new CUIEventManager.OnUIEventHandler(this.OnSubListShow));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Pvp_Graph_Show, new CUIEventManager.OnUIEventHandler(this.OnGraphShow));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Pvp_Detail_Show, new CUIEventManager.OnUIEventHandler(this.OnDetailShow));
		}

		public override void UnInit()
		{
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Pvp_MainList_Click, new CUIEventManager.OnUIEventHandler(this.OnMainListClick));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Pvp_SubList_Click, new CUIEventManager.OnUIEventHandler(this.OnSubListClick));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Pvp_SubList_Show, new CUIEventManager.OnUIEventHandler(this.OnSubListShow));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Pvp_Graph_Show, new CUIEventManager.OnUIEventHandler(this.OnGraphShow));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Pvp_Detail_Show, new CUIEventManager.OnUIEventHandler(this.OnDetailShow));
		}
		...
		public void UpdateUI()
		{
			...
			if (subTab == SubTab.MatchAll || subTab == SubTab.Match5V5 || subTab == SubTab.MatchRank || subTab == SubTab.MatchGuild)
			{
				...
				Utility.GetComponetInChild<Text>(p, "DateBar3/txt9").text = (this.m_ability[1] * 100f).ToString("F1");
			}
			else
			{
			...
			Utility.GetComponetInChild<Image>(p, "DateBar3/Bar").fillAmount = CPlayerProfile.Divide(this.m_ability[1], 1f);
			this.InitTemVector();
			...
			obj.CustomSetActive(CPlayerInfoSystem.isSelf(Singleton<CPlayerInfoSystem>.get_instance().GetProfile().m_uuid));
		...
		private void InitBaseValue()
		{
			...
			GameDataMgr.svr2CltCfgDict.TryGetValue(16u, ref resGlobalInfo);
			if (resGlobalInfo == null)
			{
				return;
			}
			this.m_baseValueKDA = resGlobalInfo.dwConfValue;
			GameDataMgr.svr2CltCfgDict.TryGetValue(17u, ref resGlobalInfo);
			if (resGlobalInfo == null)
			{
				return;
			}
			this.m_baseValueGold = resGlobalInfo.dwConfValue;
			GameDataMgr.svr2CltCfgDict.TryGetValue(18u, ref resGlobalInfo);
			if (resGlobalInfo == null)
			{
				return;
			}
			this.m_baseValueBattle = resGlobalInfo.dwConfValue;
			GameDataMgr.svr2CltCfgDict.TryGetValue(19u, ref resGlobalInfo);
			if (resGlobalInfo == null)
			{
				return;
			}
			this.m_baseValueAlive = resGlobalInfo.dwConfValue;
			GameDataMgr.svr2CltCfgDict.TryGetValue(20u, ref resGlobalInfo);
			if (resGlobalInfo == null)
			{
				return;
			}
		...
		private static void ConvertAbilityData(CPlayerProfile profile, MainTab mainTab, SubTab subTab, float[] ability)
		{
			...
			ability[1] = cSDT_STATISTIC_DATA_EXTRA_RADAR_INFO.dwTotal / 100f;
