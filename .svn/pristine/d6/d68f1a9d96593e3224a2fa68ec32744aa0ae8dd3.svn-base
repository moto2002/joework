...
namespace Assets.Scripts.GameLogic
{
	public class TipProcessor : Singleton<TipProcessor>
	{
		...
		{
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Battle_Guide_PanelMisson_1_Close, new CUIEventManager.OnUIEventHandler(this.OnGuidePanelMissonClose));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Battle_Guide_PanelMisson_2_Close, new CUIEventManager.OnUIEventHandler(this.OnGuidePanelMissonClose));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Battle_Guide_PanelMisson_3_Close, new CUIEventManager.OnUIEventHandler(this.OnGuidePanelMissonClose));
		}

		public void Uninit()
		{
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Battle_Guide_PanelMisson_1_Close, new CUIEventManager.OnUIEventHandler(this.OnGuidePanelMissonClose));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Battle_Guide_PanelMisson_2_Close, new CUIEventManager.OnUIEventHandler(this.OnGuidePanelMissonClose));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Battle_Guide_PanelMisson_3_Close, new CUIEventManager.OnUIEventHandler(this.OnGuidePanelMissonClose));
		}
