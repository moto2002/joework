...
namespace Assets.Scripts.GameLogic
{
	public class VDStat
	{
		...
		public void StartRecord()
		{
			...
			if (this.ShouldStat())
			{
				Singleton<EventRouter>.get_instance().AddEventHandler<PoolObjHandle<ActorRoot>, int, bool, PoolObjHandle<ActorRoot>>("HeroGoldCoinInBattleChange", new Action<PoolObjHandle<ActorRoot>, int, bool, PoolObjHandle<ActorRoot>>(this.OnHeroGoldCoinChanged));
			}
		}
		...
		public void Clear()
		{
			...
			Singleton<EventRouter>.get_instance().RemoveEventHandler<PoolObjHandle<ActorRoot>, int, bool, PoolObjHandle<ActorRoot>>("HeroGoldCoinInBattleChange", new Action<PoolObjHandle<ActorRoot>, int, bool, PoolObjHandle<ActorRoot>>(this.OnHeroGoldCoinChanged));
		}
		...
		{
			uint num = Singleton<FrameSynchr>.get_instance().CurFrameNum / VDStat.StepCount;
