...
public class CVersion
{
	...
	private static void Initialize()
	{
		...
		CVersion.s_iOSBundleVersion = string.Format("{0}{1}", CVersion.s_codeVersion, (CVersion.s_resourceVersion.get_Length() != 1) ? CVersion.s_resourceVersion : ("0" + CVersion.s_resourceVersion));
		int num = 0;
