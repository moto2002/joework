...
public class CRoleRegisterView
{
	...
	public static string RoleName
	{
		get
		{
			CUIFormScript form = Singleton<CUIManager>.get_instance().GetForm(CRoleRegisterSys.s_roleCreateFormPath);
			if (form != null)
			{
	...
	{
		Singleton<CUIManager>.get_instance().CloseForm(CRoleRegisterSys.s_gameDifficultSelectFormPath);
	}

	public static void SetGameDifficult(int difficult)
	{
		CUIFormScript form = Singleton<CUIManager>.get_instance().GetForm(CRoleRegisterSys.s_gameDifficultSelectFormPath);
		if (form != null)
		{
