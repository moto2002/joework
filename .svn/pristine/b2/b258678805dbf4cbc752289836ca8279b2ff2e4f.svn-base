...
namespace Assets.Scripts.GameLogic
{
	public class GameLoader : MonoSingleton<GameLoader>
	{
		...
		{
			GameLoader.<LoadCommonAssetBundle>c__Iterator14 <LoadCommonAssetBundle>c__Iterator = new GameLoader.<LoadCommonAssetBundle>c__Iterator14();
		...
		{
			GameLoader.<LoadCommonEffect>c__Iterator15 <LoadCommonEffect>c__Iterator = new GameLoader.<LoadCommonEffect>c__Iterator15();
		...
		{
			GameLoader.<LoadArtistLevel>c__Iterator16 <LoadArtistLevel>c__Iterator = new GameLoader.<LoadArtistLevel>c__Iterator16();
		...
		{
			GameLoader.<LoadDesignLevel>c__Iterator17 <LoadDesignLevel>c__Iterator = new GameLoader.<LoadDesignLevel>c__Iterator17();
		...
		{
			GameLoader.<LoadCommonAssets>c__Iterator18 <LoadCommonAssets>c__Iterator = new GameLoader.<LoadCommonAssets>c__Iterator18();
		...
		{
			GameLoader.<AnalyseResourcePreload>c__Iterator19 <AnalyseResourcePreload>c__Iterator = new GameLoader.<AnalyseResourcePreload>c__Iterator19();
		...
		{
			GameLoader.<AnalyseActorAssets>c__Iterator1A <AnalyseActorAssets>c__Iterator1A = new GameLoader.<AnalyseActorAssets>c__Iterator1A();
			<AnalyseActorAssets>c__Iterator1A.loadHelper = loadHelper;
			<AnalyseActorAssets>c__Iterator1A.<$>loadHelper = loadHelper;
			<AnalyseActorAssets>c__Iterator1A.<>f__this = this;
			return <AnalyseActorAssets>c__Iterator1A;
		}

		[DebuggerHidden]
		private IEnumerator LoadActorAssets(GameLoader.LHCWrapper InWrapper)
		{
			GameLoader.<LoadActorAssets>c__Iterator1B <LoadActorAssets>c__Iterator1B = new GameLoader.<LoadActorAssets>c__Iterator1B();
			<LoadActorAssets>c__Iterator1B.InWrapper = InWrapper;
			<LoadActorAssets>c__Iterator1B.<$>InWrapper = InWrapper;
			<LoadActorAssets>c__Iterator1B.<>f__this = this;
			return <LoadActorAssets>c__Iterator1B;
		}
		...
		{
			GameLoader.<AnalyseNoActorAssets>c__Iterator1C <AnalyseNoActorAssets>c__Iterator1C = new GameLoader.<AnalyseNoActorAssets>c__Iterator1C();
			<AnalyseNoActorAssets>c__Iterator1C.loadHelper = loadHelper;
			<AnalyseNoActorAssets>c__Iterator1C.<$>loadHelper = loadHelper;
			<AnalyseNoActorAssets>c__Iterator1C.<>f__this = this;
			return <AnalyseNoActorAssets>c__Iterator1C;
		}

		[DebuggerHidden]
		private IEnumerator LoadNoActorAssets(GameLoader.LHCWrapper InWrapper)
		{
			GameLoader.<LoadNoActorAssets>c__Iterator1D <LoadNoActorAssets>c__Iterator1D = new GameLoader.<LoadNoActorAssets>c__Iterator1D();
			<LoadNoActorAssets>c__Iterator1D.InWrapper = InWrapper;
			<LoadNoActorAssets>c__Iterator1D.<$>InWrapper = InWrapper;
			<LoadNoActorAssets>c__Iterator1D.<>f__this = this;
			return <LoadNoActorAssets>c__Iterator1D;
		}

		[DebuggerHidden]
		private IEnumerator AnalyseAgeRecursiveAssets(LoaderHelper loadHelper)
		{
			GameLoader.<AnalyseAgeRecursiveAssets>c__Iterator1E <AnalyseAgeRecursiveAssets>c__Iterator1E = new GameLoader.<AnalyseAgeRecursiveAssets>c__Iterator1E();
			<AnalyseAgeRecursiveAssets>c__Iterator1E.loadHelper = loadHelper;
			<AnalyseAgeRecursiveAssets>c__Iterator1E.<$>loadHelper = loadHelper;
			<AnalyseAgeRecursiveAssets>c__Iterator1E.<>f__this = this;
			return <AnalyseAgeRecursiveAssets>c__Iterator1E;
		}

		[DebuggerHidden]
		private IEnumerator LoadAgeRecursiveAssets(GameLoader.LHCWrapper InWrapper)
		{
			GameLoader.<LoadAgeRecursiveAssets>c__Iterator1F <LoadAgeRecursiveAssets>c__Iterator1F = new GameLoader.<LoadAgeRecursiveAssets>c__Iterator1F();
			<LoadAgeRecursiveAssets>c__Iterator1F.InWrapper = InWrapper;
			<LoadAgeRecursiveAssets>c__Iterator1F.<$>InWrapper = InWrapper;
			<LoadAgeRecursiveAssets>c__Iterator1F.<>f__this = this;
			return <LoadAgeRecursiveAssets>c__Iterator1F;
		}

		[DebuggerHidden]
		private IEnumerator SpawnStaticActor(GameLoader.LoaderHelperWrapper InWrapper)
		{
			GameLoader.<SpawnStaticActor>c__Iterator20 <SpawnStaticActor>c__Iterator = new GameLoader.<SpawnStaticActor>c__Iterator20();
		...
		{
			GameLoader.<SpawnDynamicActor>c__Iterator21 <SpawnDynamicActor>c__Iterator = new GameLoader.<SpawnDynamicActor>c__Iterator21();
		...
		{
			GameLoader.<PreSpawnSoldiers>c__Iterator22 <PreSpawnSoldiers>c__Iterator = new GameLoader.<PreSpawnSoldiers>c__Iterator22();
		...
		{
			GameLoader.<CoroutineLoad>c__Iterator23 <CoroutineLoad>c__Iterator = new GameLoader.<CoroutineLoad>c__Iterator23();
		...
		public void AdvanceStopLoad()
		{
			if (this.isLoadStart)
			{
				...
				GC.Collect();
				Singleton<EventRouter>.get_instance().BroadCastEvent(EventID.ADVANCE_STOP_LOADING);
			}
			this.ResetLoader();
		}
	}
