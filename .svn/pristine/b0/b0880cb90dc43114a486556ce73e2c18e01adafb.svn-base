...
public class Sprite3D : MonoBehaviour
{
	...
	public void RefreshAtlasMaterial()
	{
		...
		{
			this.m_render.sharedMaterial = this.m_atlas.get_material();
		}
	}
	...
	private void GenerateHoriontalFillMesh()
	{
		...
		{
			this.m_uv.uvTL,
			MMGame_Math.Lerp(this.m_uv.uvTL, this.m_uv.uvTR, this.m_fillAmount),
			this.m_uv.uvBL,
			MMGame_Math.Lerp(this.m_uv.uvBL, this.m_uv.uvBR, this.m_fillAmount)
		};
