...
namespace Assets.Scripts.GameSystem
{
	...
	public class CSymbolSystem : Singleton<CSymbolSystem>
	{
		...
		public override void Init()
		{
			...
			Singleton<EventRouter>.get_instance().AddEventHandler("MasterSymbolCoinChanged", new Action(this.OnSymbolCoinChanged));
		}
		...
		public override void UnInit()
		{
			...
			Singleton<EventRouter>.get_instance().RemoveEventHandler("MasterSymbolCoinChanged", new Action(this.OnSymbolCoinChanged));
		}
		...
		public static void ReciveSymbolDatail(CSPkg msg)
		{
			...
			SCPKG_CMD_SYMBOLDETAIL stSymbolDetail = msg.stPkgData.get_stSymbolDetail();
			CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
			if (masterRoleInfo != null)
			{
