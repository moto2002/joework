...
namespace AGE
{
	...
	public class ChangeAnimDuration : DurationCondition
	{
		...
		private void Init(Action _action, Track _track)
		{
			...
			{
				this.actorHandle.get_handle().AnimControl.ChangeAnimParam(this.originalAnimName, this.changedAnimName);
			}
		}
		...
		public override void Leave(Action _action, Track _track)
		{
			...
			if (this.actorHandle)
			{
				this.actorHandle.get_handle().AnimControl.RecoverAnimParam(this.originalAnimName);
			}
