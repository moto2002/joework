...
namespace Assets.Scripts.GameSystem
{
	public class RankingView
	{
		...
		public static void ShowAllRankMenu()
		{
			...
			obj.CustomSetActive(!Singleton<CFunctionUnlockSys>.get_instance().FucIsUnlock(9));
			Singleton<CUINewFlagSystem>.GetInstance().SetNewFlagForArenaRankBtn(true);
			Singleton<CUINewFlagSystem>.GetInstance().SetNewFlagForGodRankBtn(true);
		}
		...
		public static void OnRankGodDetailEquipClick(CEquipInfo equipInfo, string playerName, string heroName)
		{
			...
			componetInChild.text = Singleton<CTextManager>.get_instance().GetText("RankGodHeroEquipDesc", new string[]
			{
				playerName,
				heroName
			});
