...
public class AkMemBankLoader : MonoBehaviour
{
	...
	{
		AkMemBankLoader.<LoadFile>c__Iterator3A <LoadFile>c__Iterator3A = new AkMemBankLoader.<LoadFile>c__Iterator3A();
		<LoadFile>c__Iterator3A.<>f__this = this;
		return <LoadFile>c__Iterator3A;
	}
