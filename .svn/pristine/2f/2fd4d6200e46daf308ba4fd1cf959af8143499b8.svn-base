	...
	public class QQVipWidget : Singleton<QQVipWidget>
	{
		...
		public void SetData(GameObject root, CUIFormScript formScript)
		{
			...
			for (int i = 0; i < 3; i++)
			{
				...
				CUseable cUseable = CUseableManager.CreateUsableByRandowReward(resDT_RandomRewardInfo.bItemType, (int)resDT_RandomRewardInfo.dwLowCnt, resDT_RandomRewardInfo.dwItemID);
				if (cUseable != null)
				{
			...
			for (int j = 0; j < 3; j++)
			{
				...
				CUseable cUseable2 = CUseableManager.CreateUsableByRandowReward(resDT_RandomRewardInfo2.bItemType, (int)resDT_RandomRewardInfo2.dwLowCnt, resDT_RandomRewardInfo2.dwItemID);
				if (cUseable2 != null)
				{
