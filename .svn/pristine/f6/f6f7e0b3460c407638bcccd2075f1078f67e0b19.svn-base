...
public class GameObjectWrap
{
	...
	private static int get_rigidbody(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_rigidbody());
		return 1;
	}
	...
	private static int get_rigidbody2D(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_rigidbody2D());
		return 1;
	}
	...
	private static int get_camera(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_camera());
		return 1;
	}
	...
	private static int get_light(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_light());
		return 1;
	}
	...
	private static int get_animation(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_animation());
		return 1;
	}
	...
	private static int get_constantForce(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_constantForce());
		return 1;
	}
	...
	private static int get_renderer(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_renderer());
		return 1;
	}
	...
	private static int get_audio(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_audio());
		return 1;
	}
	...
	private static int get_guiText(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_guiText());
		return 1;
	}
	...
	private static int get_networkView(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_networkView());
		return 1;
	}
	...
	private static int get_guiTexture(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_guiTexture());
		return 1;
	}
	...
	private static int get_collider(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_collider());
		return 1;
	}
	...
	private static int get_collider2D(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_collider2D());
		return 1;
	}
	...
	private static int get_hingeJoint(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_hingeJoint());
		return 1;
	}
	...
	private static int get_particleEmitter(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_particleEmitter());
		return 1;
	}
	...
	private static int get_particleSystem(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, gameObject.get_particleSystem());
		return 1;
	}
	...
	private static int SampleAnimation(IntPtr L)
	{
		...
		AnimationClip animationClip = (AnimationClip)LuaScriptMgr.GetUnityObject(L, 2, typeof(AnimationClip));
		float num = (float)LuaScriptMgr.GetNumber(L, 3);
