...
namespace AGE
{
	...
	public class SpawnPetDuration : DurationEvent
	{
		...
		public override void Enter(Action _action, Track _track)
		{
			...
			if (this.actorObj && this.actorObj.get_handle().PetControl != null)
			{
				this.actorObj.get_handle().PetControl.CreatePet(this.petType, this.prefabName, this.offset);
			}
		}
		...
		public override void Leave(Action _action, Track _track)
		{
			if (this.actorObj && this.actorObj.get_handle().PetControl != null)
			{
				this.actorObj.get_handle().PetControl.DestoryPet(this.petType);
			}
