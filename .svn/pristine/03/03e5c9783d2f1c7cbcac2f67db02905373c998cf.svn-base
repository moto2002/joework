...
namespace Assets.Scripts.GameLogic
{
	public class Horizon : IUpdateLogic
	{
		...
		public bool Enabled
		{
			...
			set
			{
				if (value != this._enabled)
				{
					...
					{
						gameActors.get_Item(i).get_handle().HorizonMarker.SetEnabled(this._enabled);
					}
				}
			}
		}
		...
		public void FightStart()
		{
			...
			this._enabled = (Singleton<BattleLogic>.get_instance().GetCurLvelContext().m_horizonEnableMethod == Horizon.EnableMethod.EnableAll);
		}
