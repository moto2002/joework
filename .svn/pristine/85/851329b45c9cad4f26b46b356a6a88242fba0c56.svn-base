...
internal class SetHeroQualityCommand : CheatCommandNetworking
{
	protected override string Execute(string[] InArguments, ref CSDT_CHEATCMD_DETAIL CheatCmdRef)
	{
		...
		CheatCmdRef.set_stSetHeroQuality(new CSDT_CHEAT_SETHEROQUALITY());
		CheatCmdRef.get_stSetHeroQuality().dwHeroID = (uint)dwHeroID;
		CheatCmdRef.get_stSetHeroQuality().stQuality.wQuality = (ushort)num;
		CheatCmdRef.get_stSetHeroQuality().stQuality.wSubQuality = (ushort)num2;
