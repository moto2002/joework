...
namespace Assets.Scripts.GameLogic
{
	...
	internal class StarConditionPVPAchievement : StarCondition
	{
		...
		{
			if (KillDetail.Killer && KillDetail.Killer.get_handle().TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Hero && ActorHelper.IsHostCtrlActor(ref KillDetail.Killer) && (KillDetail.HeroContiKillType == this.targetAchievementType || KillDetail.HeroMultiKillType == this.targetAchievementType))
			{
				this.CompleteCount++;
