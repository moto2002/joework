...
namespace Assets.Scripts.GameSystem
{
	...
	public class CSymbolRecommendController
	{
		...
		public static void SendReqSelectHeroLvl(uint heroId, ushort level)
		{
			...
			cSPkg.stPkgData.get_stSymbolRcmdSelReq().dwHeroID = heroId;
			cSPkg.stPkgData.get_stSymbolRcmdSelReq().wSymbolLvl = level;
		...
		public static void ReciveSymbolRcmdHeroLvl(CSPkg msg)
		{
			...
			SCPKG_CMD_SYMBOLRCMD_SEL stSymbolRcmdSelRsp = msg.stPkgData.get_stSymbolRcmdSelRsp();
		...
		{
			Singleton<CUIManager>.GetInstance().CloseSendMsgAlert();
			SCPKG_CMD_SYMBOLRCMD_WEAR stSymbolRcmdWearRsp = msg.stPkgData.get_stSymbolRcmdWearRsp();
		}
	}
}
