			...
			else
			{
				...
				for (int j = 0; j < this.m_characterCount; j++)
				{
					...
					else if (((char.IsPunctuation(character2) || char.IsWhiteSpace(character2) || j == this.m_characterCount - 1) && flag6) || j == 0)
					{
						...
						tMP_WordInfo.lastCharacterIndex = num50;
						tMP_WordInfo.characterCount = num50 - num38 + 1;
				...
				this.m_textInfo.wordCount = (int)((num35 == 0 || this.m_characterCount <= 0) ? 1 : ((short)num35));
