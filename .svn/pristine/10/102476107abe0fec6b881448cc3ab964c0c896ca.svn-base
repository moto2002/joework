Shader "S_Game_Scene/Alpha_Blend" {
Properties {
...
void main ()
{
  lowp vec4 c_1;
  lowp float tmpvar_2;
  tmpvar_2 = (texture2D (_MainTex, xlv_TEXCOORD0) * _Color).w;
  lowp vec4 c_3;
...
void main ()
{
  lowp vec4 c_1;
  lowp float tmpvar_2;
  tmpvar_2 = (texture (_MainTex, xlv_TEXCOORD0) * _Color).w;
  lowp vec4 c_3;
  c_3.xyz = vec3(0.0, 0.0, 0.0);
  c_3.w = tmpvar_2;
  c_1.xyz = c_3.xyz;
