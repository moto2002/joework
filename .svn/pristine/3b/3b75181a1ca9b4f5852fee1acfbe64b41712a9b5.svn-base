...
namespace AGE
{
	...
	public class PlayHeroSoundTick : TickEvent
	{
		...
		public override void Process(Action _action, Track _track)
		{
			...
			{
				Singleton<CSoundManager>.get_instance().PlayBattleSound(this.eventName, actorHandle, gameObject);
			}
			else
			{
				Singleton<CSoundManager>.get_instance().PlayBattleSound(this.CachedEventName, actorHandle, gameObject);
			}
		}
	}
}
