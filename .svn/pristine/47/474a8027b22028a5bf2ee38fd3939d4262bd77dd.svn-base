...
namespace AGE
{
	public class RefParamOperator
	{
		...
		public ListView<RefData> GetSrcRefDataList(string name)
		{
			...
			{
				this.owner.refParamsSrc.refDataList.TryGetValue(name, ref result);
			}
			return result;
		}
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.Bool)
			{
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.Int)
			{
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.UInt)
			{
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.Float)
			{
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.VInt3)
			{
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.Vector3)
			{
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.Quaternion)
			{
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.Object)
			{
				value = sRefParam.obj;
				return true;
			}
		...
		{
			SRefParam sRefParam = null;
			if (this.refParamList.TryGetValue(name, ref sRefParam) && sRefParam.type == SRefParam.ValType.ActorRoot)
			{
