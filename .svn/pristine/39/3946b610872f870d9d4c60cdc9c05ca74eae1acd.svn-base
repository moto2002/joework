	...
	public class CMiShuSystem : Singleton<CMiShuSystem>
	{
		...
		public void InitList(int TabIndex, CUIListScript list)
		{
			...
			for (int i = 0; i < resList.Length; i++)
			{
				...
				this.InitSysBtn(component6, resList[i].bGotoID, component3.gameObject, component5.gameObject);
		...
		public static void SendUIClickToServer(enUIClickReprotID clickID)
		{
			...
			cSPkg.stPkgData.get_stCltActionStatistics().bActionType = 1;
			cSPkg.stPkgData.get_stCltActionStatistics().stActionData.construct((long)cSPkg.stPkgData.get_stCltActionStatistics().bActionType);
			cSPkg.stPkgData.get_stCltActionStatistics().stActionData.get_stSecretary().iID = (int)clickID;
