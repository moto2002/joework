...
namespace Assets.Scripts.UI
{
	public class CUIUtility
	{
		...
		{
			GameObject gameObject = Singleton<CResourceManager>.GetInstance().GetResource(prefebPath, typeof(GameObject), 6, needCached, unloadBelongedAssetBundleAfterLoaded).m_content as GameObject;
			if (gameObject == null)
			{
				gameObject = (Singleton<CResourceManager>.GetInstance().GetResource(CUIUtility.s_Sprite_Dynamic_Icon_Dir + "0", typeof(GameObject), 6, true, true).m_content as GameObject);
			}
			return gameObject;
		}
