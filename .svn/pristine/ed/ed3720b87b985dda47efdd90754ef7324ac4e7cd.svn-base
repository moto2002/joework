...
namespace AGE
{
	...
	public class ChangeSkillTriggerTick : TickEvent
	{
		...
		private bool CheckChangeSkillCondition(Action _action)
		{
			...
			return actorHandle && actorHandle.get_handle().ActorControl.IsDeadState;
		}
		...
		public override void Process(Action _action, Track _track)
		{
			...
			if (skillControl.TryGetSkillSlot(this.slotType, out skillSlot) && skillSlot != null)
			{
				...
				skillSlot.skillChangeEvent.Start(time, num2, this.recoverSkillID, this.bOvertimeCD, this.bSendEvent, this.bAbort, this.bUseStop);
			}
		}
	}
}
