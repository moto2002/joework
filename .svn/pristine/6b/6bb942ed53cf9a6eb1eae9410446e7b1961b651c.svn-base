...
public class SceneManagement : Singleton<SceneManagement>
{
	...
	public class Node : PooledClassObject
	{
		...
		public void Attach()
		{
			if (!this.owner || this.owner.get_handle().shape == null || this.owner.get_handle().TheActorMeta.ActorType == ActorTypeDef.Invalid || this.attached)
			{
				return;
			}
			SceneManagement instance = Singleton<SceneManagement>.GetInstance();
			instance.GetCoord(ref this.coord, this.owner.get_handle().shape);
		...
		public void Update()
		{
			if (this.dirty && this.owner && this.owner.get_handle().shape != null)
			{
				SceneManagement instance = Singleton<SceneManagement>.get_instance();
				SceneManagement.Coordinate coordinate = default(SceneManagement.Coordinate);
				instance.GetCoord(ref coordinate, this.owner.get_handle().shape);
	...
	public void InitScene()
	{
		...
		Bounds forcedBounds = active.astarData.recastGraph.get_forcedBounds();
		...
		this.TileOrigin = ((VInt3)forcedBounds.min).get_xz();
