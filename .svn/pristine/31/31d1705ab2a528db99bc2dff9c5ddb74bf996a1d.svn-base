...
namespace Assets.Scripts.GameSystem
{
	internal class CSettlementView
	{
			...
			if (masterRoleInfo != null)
			{
				...
				if (dataByKey != null)
				{
					...
					if (!CSysDynamicBlock.bSocialBlocked)
					{
						...
						MonoSingleton<NobeSys>.GetInstance().SetNobeIcon(component6, (int)Singleton<CRoleInfoManager>.get_instance().GetMasterRoleInfo().GetNobeInfo().stGameVipClient.dwCurLevel, false);
						MonoSingleton<NobeSys>.GetInstance().SetHeadIconBk(component7, (int)Singleton<CRoleInfoManager>.get_instance().GetMasterRoleInfo().GetNobeInfo().stGameVipClient.dwHeadIconId);
					}
					else
					{
						MonoSingleton<NobeSys>.GetInstance().SetNobeIcon(component6, 0, false);
					}
					...
					if (curLvelContext.IsGameTypeLadder())
					{
						...
						if (rankInfo != null)
						{
							...
							component8.text = StringHelper.UTF8BytesToString(ref GameDataMgr.rankGradeDatabin.GetDataByKey((uint)rankInfo.bNowGrade).szGradeDesc);
					...
					if (multiDetail != null)
					{
						...
						if (multiple > 0)
						{
							...
							array2[0] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_1", new string[]
							{
								text
							});
							if (array != null)
							{
								...
								while ((long)num2 < (long)((ulong)multipleInfo))
								{
									...
									{
									case 1:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_6", new string[]
										{
											text2
										});
										break;
									case 2:
										...
										{
											array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_9", new string[]
											{
												text2
											});
										}
										...
										{
											array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_3", new string[]
											{
												text2
											});
										}
										break;
									case 3:
										array2[num2 + 1] = string.Format(Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_4"), text2, masterRoleInfo.GetExpWinCount(), Math.Ceiling((double)((float)masterRoleInfo.GetExpExpireHours() / 24f)));
										break;
									case 4:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_2", new string[]
										{
										...
										break;
									case 5:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_13", new string[]
										{
											text2
										});
										break;
									case 6:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_15", new string[]
										{
											text2
										});
										break;
									case 7:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Daily_Quest_FirstVictoryName", new string[]
										{
											text2
										});
										break;
									case 8:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_16", new string[]
										{
											text2
										});
										break;
									case 9:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_14", new string[]
										{
											text2
										});
										break;
									case 10:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_21", new string[]
										{
											text2
										});
										break;
									case 11:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_17", new string[]
										{
											text2
										});
										break;
									case 12:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_18", new string[]
										{
											text2
										});
										break;
									case 13:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_20", new string[]
										{
											text2
										});
										break;
									case 14:
										array2[num2 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_19", new string[]
										{
											text2
										});
										break;
						...
						if (multiple2 > 0)
						{
							...
							array2[0] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_7", new string[]
							{
								text3
							});
							if (array3 != null)
							{
								...
								while ((long)num3 < (long)((ulong)multipleInfo2))
								{
									...
									{
									case 1:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_6", new string[]
										{
											text4
										});
										break;
									case 2:
										if (masterRoleInfo.HasVip(16))
										{
											array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_9", new string[]
											{
												text4
											});
										}
										...
										{
											array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_3", new string[]
											{
												text4
											});
										}
										break;
									case 3:
										array2[num3 + 1] = string.Format(Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_10"), text4, masterRoleInfo.GetCoinWinCount(), Math.Ceiling((double)((float)masterRoleInfo.GetCoinExpireHours() / 24f)));
										break;
									case 4:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_2", new string[]
										{
											masterRoleInfo.dailyPvpCnt.ToString(),
											text4
										});
										break;
									case 5:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_13", new string[]
										{
											text4
										});
										break;
									case 6:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_15", new string[]
										{
											text4
										});
										break;
									case 7:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Daily_Quest_FirstVictoryName", new string[]
										{
											text4
										});
										break;
									case 8:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_16", new string[]
										{
											text4
										});
										break;
									case 9:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_14", new string[]
										{
											text4
										});
										break;
									case 10:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_21", new string[]
										{
											text4
										});
										break;
									case 11:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_17", new string[]
										{
											text4
										});
										break;
									case 12:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_18", new string[]
										{
											text4
										});
										break;
									case 13:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_20", new string[]
										{
											text4
										});
										break;
									case 14:
										array2[num3 + 1] = Singleton<CTextManager>.get_instance().GetText("Pvp_settle_Common_Tips_19", new string[]
										{
											text4
										});
										break;
		...
		private static void SetHeroStat_Share(CUIFormScript formScript, GameObject item, HeroKDA kda, bool bSelf, bool bMvp, bool bWin)
		{
			...
			string text3 = (kda.numAssist >= 10) ? kda.numAssist.ToString() : string.Format(" {0}", kda.numAssist.ToString());
			item.transform.Find("Txt_KDA").gameObject.GetComponent<Text>().text = string.Format("{0} / {1} / {2}", text, text2, text3);
