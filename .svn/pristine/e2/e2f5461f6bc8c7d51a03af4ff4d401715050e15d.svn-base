...
namespace CSProtocol
{
	public class CSPkgBody : ProtocolObject
	{
		...
		public CSPKG_GUILDREWARDPOINT_NTF stNtfGuildRewardPoint
		{
			get
			{
				return this.dataObject as CSPKG_GUILDREWARDPOINT_NTF;
			}
			set
			{
				this.dataObject = value;
		...
		public ProtocolObject select(long selector)
		{
			...
			else if (selector <= 1216L)
			{
				this.select_1145_1216(selector);
			}
			else if (selector <= 1363L)
			{
				this.select_1217_1363(selector);
			}
			else if (selector <= 1806L)
			{
				this.select_1364_1806(selector);
			}
			else if (selector <= 2033L)
			{
				this.select_1807_2033(selector);
			}
			else if (selector <= 2255L)
			{
				this.select_2034_2255(selector);
			}
			else if (selector <= 2611L)
			{
				this.select_2256_2611(selector);
			}
			else if (selector <= 4306L)
			{
				this.select_2612_4306(selector);
			}
			else if (selector <= 5212L)
			{
				this.select_4307_5212(selector);
			}
			else if (selector <= 5326L)
			{
				this.select_5213_5326(selector);
			}
			else if (selector <= 5503L)
			{
				this.select_5327_5503(selector);
			}
		...
		private void select_1145_1216(long selector)
		{
			if (selector >= 1145L && selector <= 1216L)
			{
		...
		private void select_1217_1363(long selector)
		{
			if (selector >= 1280L && selector <= 1333L)
			{
				switch ((int)(selector - 1280L))
				{
				case 0:
			...
			if (selector >= 1217L && selector <= 1263L)
			{
				switch ((int)(selector - 1217L))
				{
				case 0:
			...
			if (selector >= 1360L && selector <= 1363L)
			{
				switch ((int)(selector - 1360L))
				{
				case 0:
			...
			if (selector != 1350L)
			{
				...
				else if (!(this.dataObject is SCPKG_CMD_LICENSE_RSP))
				{
					if (this.dataObject != null)
					{
						this.dataObject.Release();
			...
			else if (!(this.dataObject is CSPKG_CMD_LICENSE_REQ))
			{
				if (this.dataObject != null)
				{
					this.dataObject.Release();
		...
		private void select_1364_1806(long selector)
		{
			if (selector >= 1400L && selector <= 1450L)
			{
				switch ((int)(selector - 1400L))
				{
				case 0:
				...
				case 41:
					...
					return;
				case 42:
					if (!(this.dataObject is SCPKG_FIGHTHISTORYLIST_RSP))
					{
						if (this.dataObject != null)
						{
							this.dataObject.Release();
			...
			if (selector >= 1364L && selector <= 1374L)
			{
				switch ((int)(selector - 1364L))
				{
				case 0:
			...
			if (selector >= 1800L && selector <= 1806L)
			{
		...
		private void select_1807_2033(long selector)
		{
			if (selector >= 1807L && selector <= 1833L)
			{
				switch ((int)(selector - 1807L))
				{
				case 0:
			...
			if (selector >= 2010L && selector <= 2033L)
			{
			...
			if (selector >= 1901L && selector <= 1910L)
			{
		...
		private void select_2034_2255(long selector)
		{
			if (selector >= 2201L && selector <= 2255L)
			{
				switch ((int)(selector - 2201L))
				{
				case 0:
			...
			if (selector >= 2034L && selector <= 2038L)
			{
				switch ((int)(selector - 2034L))
				{
				case 0:
		...
		private void select_2256_2611(long selector)
		{
			if (selector >= 2256L && selector <= 2290L)
			{
				switch ((int)(selector - 2256L))
				{
				case 0:
			...
			if (selector >= 2600L && selector <= 2611L)
			{
		...
		private void select_2612_4306(long selector)
		{
			...
			if (selector >= 4100L && selector <= 4110L)
			{
				...
				case 3:
					...
					return;
				case 4:
					if (!(this.dataObject is SCPKG_NTF_SNS_NICKNAME))
					{
						if (this.dataObject != null)
						{
							this.dataObject.Release();
			...
			if (selector >= 4301L && selector <= 4306L)
			{
			...
			if (selector >= 2612L && selector <= 2616L)
			{
				switch ((int)(selector - 2612L))
				{
				case 0:
		...
		private void select_4307_5212(long selector)
		{
			...
			if (selector >= 5201L && selector <= 5212L)
			{
				switch ((int)(selector - 5201L))
				{
				case 0:
				...
				case 7:
					...
					return;
				case 8:
					if (!(this.dataObject is CSPKG_GUILDREWARDPOINT_NTF))
					{
						if (this.dataObject != null)
						{
							this.dataObject.Release();
						}
						this.dataObject = (CSPKG_GUILDREWARDPOINT_NTF)ProtocolObjectPool.Get(CSPKG_GUILDREWARDPOINT_NTF.CLASS_ID);
					}
					return;
				case 9:
			...
			if (selector >= 4307L && selector <= 4310L)
			{
				switch ((int)(selector - 4307L))
				{
				case 0:
		...
		private void select_5213_5326(long selector)
		{
			if (selector >= 5213L && selector <= 5326L)
			{
				switch ((int)(selector - 5213L))
				{
				case 0:
		...
		private void select_5327_5503(long selector)
		{
			if (selector >= 5402L && selector <= 5417L)
			{
			...
			if (selector >= 5327L && selector <= 5334L)
			{
				switch ((int)(selector - 5327L))
				{
				case 0:
