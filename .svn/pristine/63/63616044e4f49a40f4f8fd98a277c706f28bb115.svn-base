...
namespace Assets.Scripts.GameLogic
{
	...
	public class LimitMoveCondition : PassiveCondition
	{
		...
		{
			Singleton<GameSkillEventSys>.get_instance().RmvEventHandler<LimitMoveEventParam>(GameSkillEventDef.AllEvent_LimitMove, new GameSkillEvent<LimitMoveEventParam>(this.onActorLimitMove));
			Singleton<GameSkillEventSys>.get_instance().RmvEventHandler<LimitMoveEventParam>(GameSkillEventDef.AllEvent_CancelLimitMove, new GameSkillEvent<LimitMoveEventParam>(this.onActorCancelLimitMove));
		}
