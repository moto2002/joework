...
namespace behaviac
{
	public abstract class BehaviorNode
	{
		...
		public int GetChildrenCount()
		{
			...
			{
				return this.m_children.get_Count();
			}
			return 0;
		}
		...
		{
			if (this.m_children != null && index < this.m_children.get_Count())
			{
				return this.m_children.get_Item(index);
			}
			return null;
		}
		...
		public int GetAttachmentsCount()
		{
			...
			{
				return this.m_attachments.get_Count();
			}
			return 0;
		}
		...
		{
			if (this.m_attachments != null && index < this.m_attachments.get_Count())
			{
				return this.m_attachments.get_Item(index);
			}
			return null;
		}
		...
		private bool load_property_pars(ref List<property_t> properties, SecurityElement c, int version, string agentType)
		{
			...
			if (c.get_Tag() == "pars")
			{
				...
				{
					IEnumerator enumerator2 = c.get_Children().GetEnumerator();
					try
					{
