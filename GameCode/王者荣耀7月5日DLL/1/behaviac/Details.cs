...
namespace behaviac
{
	public static class Details
	{
		...
		public static void RegisterCompareValue()
		{
			...
			Details.ms_comparers.set_Item(typeof(int), new Details.CompareValueInt());
			Details.ms_comparers.set_Item(typeof(long), new Details.CompareValueLong());
			Details.ms_comparers.set_Item(typeof(short), new Details.CompareValueShort());
			Details.ms_comparers.set_Item(typeof(sbyte), new Details.CompareValueByte());
			Details.ms_comparers.set_Item(typeof(float), new Details.CompareValueFloat());
			Details.ms_comparers.set_Item(typeof(uint), new Details.CompareValueUInt());
			Details.ms_comparers.set_Item(typeof(ulong), new Details.CompareValueULong());
			Details.ms_comparers.set_Item(typeof(ushort), new Details.CompareValueUShort());
			Details.ms_comparers.set_Item(typeof(byte), new Details.CompareValueUByte());
			Details.ms_comparers.set_Item(typeof(double), new Details.CompareValueDouble());
		}
		...
		public static bool Greater(object lhs, object rhs)
		{
			...
			{
				Details.ICompareValue compareValue = Details.ms_comparers.get_Item(type);
		...
		public static void RegisterComputeValue()
		{
			...
			Details.ms_computers.set_Item(typeof(int), new Details.ComputeValueInt());
			Details.ms_computers.set_Item(typeof(long), new Details.ComputeValueLong());
			Details.ms_computers.set_Item(typeof(short), new Details.ComputeValueShort());
			Details.ms_computers.set_Item(typeof(sbyte), new Details.ComputeValueByte());
			Details.ms_computers.set_Item(typeof(float), new Details.ComputeValueFloat());
			Details.ms_computers.set_Item(typeof(uint), new Details.ComputeValueUInt());
			Details.ms_computers.set_Item(typeof(ulong), new Details.ComputeValueULong());
			Details.ms_computers.set_Item(typeof(ushort), new Details.ComputeValueUShort());
			Details.ms_computers.set_Item(typeof(byte), new Details.ComputeValueUByte());
			Details.ms_computers.set_Item(typeof(double), new Details.ComputeValueDouble());
		}
