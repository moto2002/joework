...
namespace AGE
{
	...
	public class BubbleTextDuration : DurationEvent
	{
		...
		{
			if (inActor && inActor.get_handle().HudControl != null)
			{
				inActor.get_handle().HudControl.SetTextHud(inText, this.Offset_x, this.Offset_y, false);
			}
		}
		...
		public override void Enter(Action _action, Track _track)
		{
			...
			{
				this.AddActorRootList(1);
				this.AddActorRootList(2);
			}
			else
			{
