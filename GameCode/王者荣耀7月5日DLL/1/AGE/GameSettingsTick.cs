...
namespace AGE
{
	...
	public class GameSettingsTick : TickEvent
	{
		...
		public override void Process(Action _action, Track _track)
		{
			...
			{
				Singleton<GameInput>.get_instance().SetSmartUse(GameSettings.TheCastType == CastType.SmartCast);
			}
			else
			{
				Singleton<GameInput>.get_instance().SetSmartUse(this.UseCastType == CastType.SmartCast);
			}
