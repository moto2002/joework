...
public class OutlineFilter : MonoBehaviour
{
	...
	public void LoadShaders()
	{
		if (!this.material)
		{
			...
			this.material.hideFlags = (HideFlags.HideInHierarchy | HideFlags.DontSaveInEditor | HideFlags.NotEditable);
		}
		if (!this.clearAlphaMat)
		{
			...
			this.clearAlphaMat.hideFlags = (HideFlags.HideInHierarchy | HideFlags.DontSaveInEditor | HideFlags.NotEditable);
		}
	}
	...
	public void UpdateParameters()
	{
		...
		float num = 1f / Camera.main.get_pixelWidth();
		float num2 = 1f / Camera.main.get_pixelHeight();
