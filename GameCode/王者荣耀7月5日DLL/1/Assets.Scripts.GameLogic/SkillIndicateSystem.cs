...
namespace Assets.Scripts.GameLogic
{
	internal class SkillIndicateSystem : Singleton<SkillIndicateSystem>
	{
		...
		{
			GameObject gameObject = Singleton<CResourceManager>.GetInstance().GetResource("Prefab_Skill_Effects/tongyong_effects/Indicator/lockt_01", typeof(GameObject), 0, false, false).m_content as GameObject;
			if (gameObject != null)
			{
			...
			gameObject = (Singleton<CResourceManager>.GetInstance().GetResource("Prefab_Skill_Effects/tongyong_effects/Indicator/select_02", typeof(GameObject), 0, false, false).m_content as GameObject);
			if (gameObject != null)
			{
			...
			Singleton<CResourceManager>.GetInstance().GetResource("Prefab_Skill_Effects/tongyong_effects/Siwang_tongyong/siwang_tongyong_01", typeof(GameObject), 0, true, false);
			gameObject = (Singleton<CResourceManager>.GetInstance().GetResource("Prefab_Skill_Effects/tongyong_effects/Indicator/lockt_01", typeof(GameObject), 0, false, false).m_content as GameObject);
			if (gameObject != null)
			{
			...
			gameObject = (Singleton<CResourceManager>.GetInstance().GetResource("Prefab_Skill_Effects/tongyong_effects/Indicator/select_b_01", typeof(GameObject), 0, false, false).m_content as GameObject);
			if (gameObject != null)
			{
