...
namespace Assets.Scripts.GameLogic
{
	public class SLevelContext
	{
		...
		public void InitPveData(ResLevelCfgInfo levelCfg, int difficult)
		{
			...
			this.m_pveLevelType = this.m_pveLevelInfo.iLevelType;
			this.m_horizonEnableMethod = (Horizon.EnableMethod)this.m_pveLevelInfo.bEnableHorizon;
			this.m_isMobaType = (this.m_pveLevelType == 0);
			...
			this.m_heroAiType = this.m_pveLevelInfo.iHeroAIType;
		...
		{
			return this.m_gameType != null && this.m_gameType != 1 && this.m_gameType != 2 && this.m_gameType != 3 && this.m_gameType != 7 && this.m_gameType != 8;
		}
		...
		{
			return this.m_gameType == 0;
		}

		public bool IsGameTypeActivity()
		{
			return this.m_gameType == 3;
		}
		...
		{
			return this.m_gameType == 1;
		}

		public bool IsGameTypePvpRoom()
		{
			return this.m_gameType == 6;
		}
		...
		{
			return this.m_gameType == 9;
		}

		public bool IsGameTypeLadder()
		{
			return this.m_gameType == 4;
		}

		public bool IsGameTypeRewardMatch()
		{
			return this.m_gameType == 10;
		}

		public bool IsGameTypeGuildMatch()
		{
			return this.m_gameType == 11;
		}
		...
		public CSDT_CAMP_EXT_GUILDMATCH[] GetCampExtGuildMatchInfo()
		{
			...
			for (int i = 0; i < 2; i++)
			{
				...
				array[i] = this.m_campExtInfos[i].stExtData.get_stGuildMatch();
			}
			return array;
		}
