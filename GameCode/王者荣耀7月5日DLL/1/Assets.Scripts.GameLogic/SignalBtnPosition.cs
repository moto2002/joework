...
namespace Assets.Scripts.GameLogic
{
	...
	public struct SignalBtnPosition : ICommandImplement
	{
		...
		public static IFrameCommand Creator(ref FRAME_CMD_PKG msg)
		{
			...
			frameCommand.cmdData.m_signalID = msg.stCmdInfo.get_stCmdSignalBtnPosition().bSignalID;
			frameCommand.cmdData.m_worldPos = CommonTools.ToVector3(msg.stCmdInfo.get_stCmdSignalBtnPosition().stWorldPos);
			return frameCommand;
		}

		public bool TransProtocol(FRAME_CMD_PKG msg)
		{
			msg.stCmdInfo.get_stCmdSignalBtnPosition().bSignalID = this.m_signalID;
			CommonTools.FromVector3(this.m_worldPos, ref msg.stCmdInfo.get_stCmdSignalBtnPosition().stWorldPos);
			return true;
		}
