...
namespace Assets.Scripts.GameLogic
{
	public struct OrganHitEffect
	{
		...
		public void OnHitEffect(OrganWrapper InWrapper)
		{
			...
			MonoSingleton<ActionManager>.GetInstance().PlayAction((actorCamp != 1) ? "Prefab_Characters/Prefab_Organ/Tower/TowerDamage_Blue" : "Prefab_Characters/Prefab_Organ/Tower/TowerDamage_Red", true, false, new GameObject[]
			{
