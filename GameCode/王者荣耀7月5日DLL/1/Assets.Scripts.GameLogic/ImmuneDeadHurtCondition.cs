...
namespace Assets.Scripts.GameLogic
{
	...
	public class ImmuneDeadHurtCondition : PassiveCondition
	{
		...
		public override void Init(PoolObjHandle<ActorRoot> _source, PassiveEvent _event, ref ResDT_SkillPassiveCondition _config)
		{
			...
			Singleton<GameEventSys>.get_instance().AddEventHandler<DefaultGameEventParam>(GameEventDef.Event_ActorImmuneDeadHurt, new RefAction<DefaultGameEventParam>(this.onImmuneDeadHurt));
		}

		public override void UnInit()
		{
			Singleton<GameEventSys>.get_instance().RmvEventHandler<DefaultGameEventParam>(GameEventDef.Event_ActorImmuneDeadHurt, new RefAction<DefaultGameEventParam>(this.onImmuneDeadHurt));
		}
