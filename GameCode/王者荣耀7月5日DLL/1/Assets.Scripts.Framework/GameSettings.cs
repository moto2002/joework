	...
	public class GameSettings
	{
		...
		public static int InBattleInputChatEnable
		{
			...
			set
			{
				...
				if (Singleton<InBattleMsgMgr>.get_instance().m_InputChat != null)
				{
					Singleton<InBattleMsgMgr>.get_instance().m_InputChat.SetInputChatEnable(GameSettings.m_clickEnableInBattleInputChat);
				}
			}
		}
		...
		public static CastType TheCastType
		{
			...
			set
			{
				...
				if (Singleton<GameInput>.get_instance() != null)
				{
					Singleton<GameInput>.get_instance().SetSmartUse(GameSettings._castType != CastType.LunPanCast);
				}
			}
		}
		...
		public static int CameraHeight
		{
			...
			set
			{
				...
				Singleton<GameEventSys>.get_instance().SendEvent(GameEventDef.Event_CameraHeightChange);
		...
		public static void ApplyShadowSettings()
		{
			...
			GameSettings.ApplyActorShadowSettings(Singleton<GameObjMgr>.get_instance().GameActors);
		}
