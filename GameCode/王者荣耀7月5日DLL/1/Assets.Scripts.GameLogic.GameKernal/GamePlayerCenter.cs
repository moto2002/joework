	...
	public class GamePlayerCenter : Singleton<GamePlayerCenter>
	{
		...
		public COM_PLAYERCAMP hostPlayerCamp
		{
			get
			{
				...
				return (hostPlayer == null) ? 0 : hostPlayer.PlayerCamp;
			}
		}
		...
		public bool isHostPlayerCaptainDead
		{
			...
			{
				Player hostPlayer = this.GetHostPlayer();
				return hostPlayer == null || !hostPlayer.Captain || hostPlayer.Captain.get_handle().ActorControl == null || hostPlayer.Captain.get_handle().ActorControl.IsDeadState;
			}
		}
