...
namespace Assets.Scripts.GameLogic.GameKernal
{
	public class GameContextEx : Singleton<GameContextEx>
	{
		...
		public void Test()
		{
			...
			for (int i = 0; i < enemyCamps.get_Count(); i++)
			{
			}
		}
		...
		{
			return this._gameContextCommonData.GameType == 9 && this._gameContextMobaData.EntertainmentMapSubType == 1;
		}

		public bool IsFireHolePlayMode()
		{
			return this._gameContextCommonData.GameType == 9 && this._gameContextMobaData.EntertainmentMapSubType == 2;
		}
		...
		{
			return this._gameContextCommonData.GameType == 2;
		}

		public bool IsGameTypeAdventure()
		{
			return this._gameContextCommonData.GameType == 0;
		}

		public bool IsGameTypeActivity()
		{
			return this._gameContextCommonData.GameType == 3;
		}

		public bool IsGameTypeBurning()
		{
			return this._gameContextCommonData.GameType == 7;
		}

		public bool IsGameTypeArena()
		{
			return this._gameContextCommonData.GameType == 8;
		}

		public bool IsGameTypeComBat()
		{
			return this._gameContextCommonData.GameType == 1;
		}

		public bool IsGameTypePvpRoom()
		{
			return this._gameContextCommonData.GameType == 6;
		}

		public bool IsGameTypePvpMatch()
		{
			return this._gameContextCommonData.GameType == 5;
		}

		public bool IsGameTypeEntertainment()
		{
			return this._gameContextCommonData.GameType == 9;
		}

		public bool IsGameTypeLadder()
		{
			return this._gameContextCommonData.GameType == 4;
		}

		public bool IsGameTypeRewardMatch()
		{
			return this._gameContextCommonData.GameType == 10;
		}
		...
		{
			this._gameContextCommonData.GameType = 12;
			...
			this._gameContextCommonData.HeroAiType = 0;
			...
			this._gameContextSoloData.PveLevelType = 0;
