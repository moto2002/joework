...
{
	public static ApolloPlatform platform = 1;
	...
	{
		CBinaryObject cBinaryObject = Singleton<CResourceManager>.GetInstance().GetResource(ApolloConfig.serverUrlPath, typeof(TextAsset), 1, false, false).m_content as CBinaryObject;
