...
public class ComponentWrap
{
	...
	private static int get_rigidbody(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_rigidbody());
		return 1;
	}
	...
	private static int get_rigidbody2D(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_rigidbody2D());
		return 1;
	}
	...
	private static int get_camera(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_camera());
		return 1;
	}
	...
	private static int get_light(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_light());
		return 1;
	}
	...
	private static int get_animation(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_animation());
		return 1;
	}
	...
	private static int get_constantForce(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_constantForce());
		return 1;
	}
	...
	private static int get_renderer(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_renderer());
		return 1;
	}
	...
	private static int get_audio(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_audio());
		return 1;
	}
	...
	private static int get_guiText(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_guiText());
		return 1;
	}
	...
	private static int get_networkView(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_networkView());
		return 1;
	}
	...
	private static int get_guiTexture(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_guiTexture());
		return 1;
	}
	...
	private static int get_collider(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_collider());
		return 1;
	}
	...
	private static int get_collider2D(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_collider2D());
		return 1;
	}
	...
	private static int get_hingeJoint(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_hingeJoint());
		return 1;
	}
	...
	private static int get_particleEmitter(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_particleEmitter());
		return 1;
	}
	...
	private static int get_particleSystem(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, component.get_particleSystem());
		return 1;
	}
