...
namespace Assets.Scripts.GameSystem
{
	public abstract class ActivityPhase
	{
		...
		public void DrawReward()
		{
			...
			cSPkg.stPkgData.get_stDrawWealReq().bWealType = this._owner.Type;
			cSPkg.stPkgData.get_stDrawWealReq().dwWealID = this._owner.ID;
			cSPkg.stPkgData.get_stDrawWealReq().dwPeriodID = this.ID;
			cSPkg.stPkgData.get_stDrawWealReq().dwDrawCnt = (uint)this.GetExchangeCountOnce();
