...
namespace Assets.Scripts.GameSystem
{
	...
	internal class CPvPHeroShop : Singleton<CPvPHeroShop>
	{
		...
		public static void OnGetFreeHero(CSPkg msg)
		{
			...
			{
				masterRoleInfo.SetFreeHeroInfo(msg.stPkgData.get_stFreeHeroRsp().stFreeHero);
				masterRoleInfo.SetFreeHeroSymbol(msg.stPkgData.get_stFreeHeroRsp().stFreeHeroSymbol);
				if ((long)CRoleInfo.GetCurrentUTCTime() >= (long)((ulong)msg.stPkgData.get_stFreeHeroRsp().stFreeHero.dwDeadline))
				{
