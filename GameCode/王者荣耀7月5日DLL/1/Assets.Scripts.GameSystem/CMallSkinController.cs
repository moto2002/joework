...
namespace Assets.Scripts.GameSystem
{
	public class CMallSkinController
	{
		...
		private void RefreshSkinListObject(CUIFormScript form)
		{
			...
			component.SetElementAmount(this.m_skinList.get_Count());
		}
		...
		public int GetSkinIndexByConfigId(uint uniSkinID = 0u)
		{
			...
			for (int i = 0; i < this.m_skinList.get_Count(); i++)
			{
				if (this.m_skinList.get_Item(i) != null && this.m_skinList.get_Item(i).dwID == uniSkinID)
				{
					return i;
				}
			}
		...
		{
			if (index >= 0 && this.m_skinList != null && this.m_skinList.get_Item(index) != null && index < this.m_skinList.get_Count())
			{
				return this.m_skinList.get_Item(index);
			}
			return null;
		}
		...
		public int GetSkinListCount()
		{
			...
			return this.m_skinList.get_Count();
		}
	}
}
