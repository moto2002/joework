...
namespace Assets.Scripts.GameSystem
{
	public class CPlayerCommonHeroInfoController : Singleton<CPlayerCommonHeroInfoController>
	{
		...
		public override void Init()
		{
			...
			{
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_36"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_37")
			};
			...
			{
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_38"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_39"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_40"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_42"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_43"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_44"),
				Singleton<CTextManager>.get_instance().GetText("Player_Info_Title_41")
			};
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Common_Hero_Enable, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroItemEnable));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Common_Hero_Main_List_Click, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroMainListClick));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Common_Hero_Sub_List_Click, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroSubListClick));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Common_Hero_Sort_List_Click, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroSortListClick));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Common_Hero_Sub_List_Show, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroSubListShow));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Player_Info_Common_Hero_Detail_List_Enable, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroListEnable));
		}

		public override void UnInit()
		{
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Common_Hero_Enable, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroItemEnable));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Common_Hero_Main_List_Click, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroMainListClick));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Common_Hero_Sub_List_Click, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroSubListClick));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Common_Hero_Sort_List_Click, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroSortListClick));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Common_Hero_Sub_List_Show, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroSubListShow));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Player_Info_Common_Hero_Detail_List_Enable, new CUIEventManager.OnUIEventHandler(this.OnCommonHeroListEnable));
		}
