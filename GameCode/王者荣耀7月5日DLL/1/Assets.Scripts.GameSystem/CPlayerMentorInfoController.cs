...
namespace Assets.Scripts.GameSystem
{
	...
	public class CPlayerMentorInfoController : Singleton<CPlayerMentorInfoController>
	{
		...
		{
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Mentor_WatchHisMentor, new CUIEventManager.OnUIEventHandler(this.OnWatchHisMentor));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Mentor_OpenMentorPage, new CUIEventManager.OnUIEventHandler(this.OnOpenMentorPage));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Mentor_ApplyRequest, new CUIEventManager.OnUIEventHandler(this.OnApplyRequest));
			Singleton<CUIEventManager>.get_instance().AddUIEventListener(enUIEventID.Mentor_OpenMentorIntro, new CUIEventManager.OnUIEventHandler(this.OnOpenMentorIntro));
		}

		public override void UnInit()
		{
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Mentor_WatchHisMentor, new CUIEventManager.OnUIEventHandler(this.OnWatchHisMentor));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Mentor_OpenMentorPage, new CUIEventManager.OnUIEventHandler(this.OnOpenMentorPage));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Mentor_ApplyRequest, new CUIEventManager.OnUIEventHandler(this.OnApplyRequest));
			Singleton<CUIEventManager>.get_instance().RemoveUIEventListener(enUIEventID.Mentor_OpenMentorIntro, new CUIEventManager.OnUIEventHandler(this.OnOpenMentorIntro));
		}
		...
		{
			if (Singleton<CPlayerInfoSystem>.get_instance().GetProfile() == null)
			{
				return;
			}
