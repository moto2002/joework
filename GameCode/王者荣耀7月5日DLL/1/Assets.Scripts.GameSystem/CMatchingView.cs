...
namespace Assets.Scripts.GameSystem
{
	public class CMatchingView
	{
		...
		public static void InitMatchingEntry(CUIFormScript form)
		{
			...
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_PVP_1V1"), ref array[0]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_PVP_3V3"), ref array[1]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_1V1_1"), ref array[2]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_1V1_1"), ref array[3]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_1V1_1"), ref array[4]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_3V3Team_1"), ref array[5]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_3V3Team_1"), ref array[6]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_3V3Team_1"), ref array[7]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_5V5Team_1"), ref array[8]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_5V5Team_1"), ref array[9]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_5V5Team_1"), ref array[10]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_Melee_Team_1"), ref array[11]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_Melee_Team_1"), ref array[12]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_Melee_Team_1"), ref array[13]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_PVP_5V5"), ref array[14]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_PVP_MELEE"), ref array[15]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_PVP_Fire"), ref array[16]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_PVP_5V5Clone"), ref array[17]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_PVP_5V5CD"), ref array[18]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_PVP_5V5Miwu"), ref array[19]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_5V5TeamMiwu_1"), ref array[20]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_5V5TeamMiwu_1"), ref array[21]);
			uint.TryParse(Singleton<CTextManager>.get_instance().GetText("MapID_Robot_5V5TeamMiwu_1"), ref array[22]);
			...
			for (int i = 0; i < array.Length; i++)
			{
				...
				array2[i].m_onClickEventParams.tag = CMatchingView.mapDifficultyList[i];
			}
			...
			if (bAvailable)
			{
				...
				else
				{
					...
					else
					{
						...
						if (!CSysDynamicBlock.bFriendBlocked)
						{
							if (Singleton<CFriendContoller>.get_instance().model.GetGameOrSnsFriend(memberInfo.uID.ullUid, (uint)memberInfo.uID.iLogicWorldId) == null)
							{
								if (transform3 != null)
								{
