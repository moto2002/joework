...
namespace Assets.Scripts.GameSystem
{
	...
	public class CSecurePwdSystem : Singleton<CSecurePwdSystem>
	{
		...
		private void ApplyForceCloseConfirm(CUIEvent uiEvent)
		{
			...
			cSPkg.stPkgData.set_stAcntPswdForceReq(cSPKG_ACNT_PSWDINFO_FORCE);
		...
		private void ApplyCancelForceCloseConfirm(CUIEvent uiEvent)
		{
			...
			cSPkg.stPkgData.set_stAcntPswdFroceCalReq(cSPKG_ACNT_PSWDINFO_FORCECAL);
			Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref cSPkg, true);
		}
		...
		private void ReqSet(string pwd)
		{
			...
			cSPkg.stPkgData.set_stAcntPswdOpenReq(cSPKG_ACNT_PSWDINFO_OPEN);
			Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref cSPkg, true);
		}
		...
		private void ReqModify(string pwd, string oldPwd = null)
		{
			...
			cSPkg.stPkgData.set_stAcntPswdChgReq(cSPKG_ACNT_PSWDINFO_CHG);
			Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref cSPkg, true);
		}
		...
		private void ReqClose(string pwd)
		{
			...
			cSPkg.stPkgData.set_stAcntPswdCloseReq(cSPKG_ACNT_PSWDINFO_CLOSE);
			Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref cSPkg, true);
		}
		...
		public static void ReceiveSetRs(CSPkg msg)
		{
			...
			if (msg.stPkgData.get_stAcntPswdOpenRsp().iResult == 0)
			{
			...
			{
				Singleton<CUIManager>.GetInstance().OpenTips(Utility.ProtErrCodeToStr(1902, msg.stPkgData.get_stAcntPswdOpenRsp().iResult), false, 1.5f, null, new object[0]);
			}
		}
		...
		{
			Singleton<CUIManager>.GetInstance().CloseSendMsgAlert();
			if (msg.stPkgData.get_stAcntPswdChgRsp().iResult == 0)
			{
				Singleton<EventRouter>.GetInstance().BroadCastEvent<OpResult>(EventID.SECURE_PWD_MODIFY_RESULT, OpResult.Success);
			}
			else
			{
				Singleton<CUIManager>.GetInstance().OpenTips(Utility.ProtErrCodeToStr(1906, msg.stPkgData.get_stAcntPswdChgRsp().iResult), false, 1.5f, null, new object[0]);
			}
		}
		...
		{
			Singleton<CUIManager>.GetInstance().CloseSendMsgAlert();
			if (msg.stPkgData.get_stAcntPswdCloseRsp().iResult == 0)
			{
			...
			{
				Singleton<CUIManager>.GetInstance().OpenTips(Utility.ProtErrCodeToStr(1904, msg.stPkgData.get_stAcntPswdCloseRsp().iResult), false, 1.5f, null, new object[0]);
			}
		}
		...
		{
			Singleton<CUIManager>.GetInstance().CloseSendMsgAlert();
			if (msg.stPkgData.get_stAcntPswdForceRsp().iResult == 0)
			{
				Singleton<CSecurePwdSystem>.GetInstance().CloseStatus = PwdCloseStatus.Open;
				Singleton<CSecurePwdSystem>.GetInstance().CloseTime = msg.stPkgData.get_stAcntPswdForceRsp().dwForceTime;
				Singleton<EventRouter>.GetInstance().BroadCastEvent<OpResult>(EventID.SECURE_PWD_FORCE_CLOSE_RESULT, OpResult.Success);
			}
			else
			{
				Singleton<CUIManager>.GetInstance().OpenTips(Utility.ProtErrCodeToStr(1908, msg.stPkgData.get_stAcntPswdForceRsp().iResult), false, 1.5f, null, new object[0]);
			}
		}
		...
		{
			Singleton<CUIManager>.GetInstance().CloseSendMsgAlert();
			if (msg.stPkgData.get_stAcntPswdFroceCalRsp().iResult == 0)
			{
			...
			{
				Singleton<CUIManager>.GetInstance().OpenTips(Utility.ProtErrCodeToStr(1910, msg.stPkgData.get_stAcntPswdFroceCalRsp().iResult), false, 1.5f, null, new object[0]);
			}
		}
	}
}
