	...
	private void InitForm()
	{
		...
		for (int i = 0; i < this.m_totalImgNum; i++)
		{
			if (this.m_stepList.GetElemenet(i) != null)
			{
				...
				CBinaryObject cBinaryObject = Singleton<CResourceManager>.GetInstance().GetResource(this.m_imgPath[i] + ".bytes", typeof(TextAsset), 6, false, false).m_content as CBinaryObject;
