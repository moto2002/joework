...
namespace tsf4g_tdr_csharp
{
	public class TdrWriteBuf : TdrBufBase
	{
		...
		{
			fixed (byte* ptr = (this._intBytes != null && this._intBytes.Length != 0) ? ref this._intBytes[0] : ref *null)
			{
				*(int*)ptr = src;
			}
		...
		{
			fixed (byte* ptr = (this._longBytes != null && this._longBytes.Length != 0) ? ref this._longBytes[0] : ref *null)
			{
				*(long*)ptr = src;
			}
