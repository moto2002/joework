...
namespace Pathfinding
{
	...
	public class AstarData
	{
		...
		{
			AstarData.<FindGraphsOfType>c__Iterator1 <FindGraphsOfType>c__Iterator = new AstarData.<FindGraphsOfType>c__Iterator1();
			<FindGraphsOfType>c__Iterator.type = type;
			<FindGraphsOfType>c__Iterator.<$>type = type;
			<FindGraphsOfType>c__Iterator.<>f__this = this;
			AstarData.<FindGraphsOfType>c__Iterator1 expr_1C = <FindGraphsOfType>c__Iterator;
			expr_1C.$PC = -2;
			return expr_1C;
		}
		...
		{
			AstarData.<GetUpdateableGraphs>c__Iterator2 <GetUpdateableGraphs>c__Iterator = new AstarData.<GetUpdateableGraphs>c__Iterator2();
			<GetUpdateableGraphs>c__Iterator.<>f__this = this;
			AstarData.<GetUpdateableGraphs>c__Iterator2 expr_0E = <GetUpdateableGraphs>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		{
			AstarData.<GetRaycastableGraphs>c__Iterator3 <GetRaycastableGraphs>c__Iterator = new AstarData.<GetRaycastableGraphs>c__Iterator3();
			<GetRaycastableGraphs>c__Iterator.<>f__this = this;
			AstarData.<GetRaycastableGraphs>c__Iterator3 expr_0E = <GetRaycastableGraphs>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
