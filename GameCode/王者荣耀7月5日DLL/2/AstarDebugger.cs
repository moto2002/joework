...
public class AstarDebugger : MonoBehaviour
{
	...
	public void Update()
	{
		...
		{
			this.graphWidth = this.cam.get_pixelWidth() * 0.8f;
			...
			Matrix4x4 m = Matrix4x4.TRS(new Vector3((this.cam.get_pixelWidth() - this.graphWidth) / 2f, this.graphOffset, 1f), Quaternion.identity, new Vector3(this.graphWidth, this.graphHeight, 1f));
