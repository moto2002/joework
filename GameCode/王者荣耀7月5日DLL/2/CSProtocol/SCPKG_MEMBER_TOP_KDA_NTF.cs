...
{
	public class SCPKG_MEMBER_TOP_KDA_NTF : ProtocolObject
	{
		...
		{
			if (cutVer == 0u || SCPKG_MEMBER_TOP_KDA_NTF.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_MEMBER_TOP_KDA_NTF.CURRVERSION;
			}
			if (SCPKG_MEMBER_TOP_KDA_NTF.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_MEMBER_TOP_KDA_NTF.CLASS_ID;
		}
