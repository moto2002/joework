...
{
	public class SCPKG_GUILD_DONATE_RSP : ProtocolObject
	{
		public byte bResult;
		...
		{
			if (cutVer == 0u || SCPKG_GUILD_DONATE_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GUILD_DONATE_RSP.CURRVERSION;
			}
			if (SCPKG_GUILD_DONATE_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_GUILD_DONATE_RSP.CLASS_ID;
		}
