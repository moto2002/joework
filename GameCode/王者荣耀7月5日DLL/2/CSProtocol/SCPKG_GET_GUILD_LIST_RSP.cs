...
namespace CSProtocol
{
	public class SCPKG_GET_GUILD_LIST_RSP : ProtocolObject
	{
		...
		public COMDT_GUILD_BRIEF_INFO[] astGuildList;
		...
		{
			this.astGuildList = new COMDT_GUILD_BRIEF_INFO[10];
			for (int i = 0; i < 10; i++)
			{
		...
		{
			if (cutVer == 0u || SCPKG_GET_GUILD_LIST_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GET_GUILD_LIST_RSP.CURRVERSION;
			}
			if (SCPKG_GET_GUILD_LIST_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_GET_GUILD_LIST_RSP.CLASS_ID;
		}
