...
namespace CSProtocol
{
	public class CSPKG_CMD_GAMELOGINREQ : ProtocolObject
	{
		...
		public COMDT_RECRUITMENT_SOURCE stRecruitSource;
		...
		public CSPKG_CMD_GAMELOGINREQ()
		{
			...
			this.stRecruitSource = (COMDT_RECRUITMENT_SOURCE)ProtocolObjectPool.Get(COMDT_RECRUITMENT_SOURCE.CLASS_ID);
		}
		...
		public override TdrError.ErrorType construct()
		{
			...
			this.bPrivilege = 0;
			errorType = this.stRecruitSource.construct();
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			errorType = this.stRecruitSource.pack(ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = this.stRecruitSource.unpack(ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override void OnRelease()
		{
			...
			this.dwTaccZoneID = 0u;
			this.bPrivilege = 0;
			if (this.stRecruitSource != null)
			{
				this.stRecruitSource.Release();
				this.stRecruitSource = null;
			}
		}
