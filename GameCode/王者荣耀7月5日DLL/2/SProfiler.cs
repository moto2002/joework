...
public class SProfiler : MonoSingleton<SProfiler>
{
	...
	public class ProfileObj
	{
		...
		private void DrawButtons()
		{
			...
			float x = 2f;
			GUI.color = Color.green;
			if (GUI.Button(new Rect(x, num3, 88f, num), "MODE"))
			{
				SProfiler.showMaxOnly = !SProfiler.showMaxOnly;
				this.Reset();
			}
			num3 += num + num2;
			if (GUI.Button(new Rect(x, num3, 88f, num), "RESET"))
			{
				this.Cleanup();
			}
			num3 += num + num2;
			...
			if (GUI.Button(new Rect(x, num3, 88f, num), "PAUSE"))
			{
			...
			if (GUI.Button(new Rect(x, num3, 88f, num), "SHOW"))
			{
			...
			if (GUI.Button(new Rect(x, num3, 88f, num), "EVENT SYS"))
			{
			...
			num3 += num + num2;
			if (GUI.Button(new Rect(x, num3, 88f, num), "SAVE"))
			{
				this.SaveProfileData();
			}
			num3 += num + num2;
			if (GUI.Button(new Rect(x, num3, 88f, num), "LOAD"))
			{
				this.RefreshProfileFiles();
				this.showProfileFiles = true;
			}
			num3 += num + num2;
			if (GUI.Button(new Rect(x, num3, 88f, num), "COMPARE"))
			{
				this.RefreshProfileFiles();
				this.showProfileFiles = true;
			...
			num3 += num + num2;
			GUI.color = color;
			if (GUI.Button(new Rect(x, num3, 88f, num), "FPS_RESET"))
			{
				FPSStatistic.Reset();
			...
			if (this.compareMode)
			{
				...
				if (GUI.Button(new Rect(x, num3, 88f, num), "[TIME]"))
				{
				...
				if (GUI.Button(new Rect(x, num3, 88f, num), "[SELF TIME]"))
				{
				...
				if (GUI.Button(new Rect(x, num3, 88f, num), "[AVG TIME]"))
				{
				...
				if (GUI.Button(new Rect(x, num3, 88f, num), "[AVG SELF]"))
				{
				...
				if (GUI.Button(new Rect(x, num3, 88f, num), "[MAX TIME]"))
				{
				...
				if (GUI.Button(new Rect(x, num3, 88f, num), "[MAX SELF]"))
				{
				...
				if (GUI.Button(new Rect(x, num3, 88f, num), "[COUNT]"))
				{
