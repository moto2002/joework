...
public class GameJoyAndroidPreRender : MonoBehaviour
{
	...
	{
		GameJoyAndroidPreRender.<CoroutineCaptureFrame>c__IteratorE <CoroutineCaptureFrame>c__IteratorE = new GameJoyAndroidPreRender.<CoroutineCaptureFrame>c__IteratorE();
		<CoroutineCaptureFrame>c__IteratorE.<>f__this = this;
		return <CoroutineCaptureFrame>c__IteratorE;
	}
