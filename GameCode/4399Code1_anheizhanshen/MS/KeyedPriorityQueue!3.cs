namespace MS
{
    ...
    {
        private List<HeapNode<K, V, P, K, V, P>> heap;
        private HeapNode<K, V, P, K, V, P> placeHolder;
        ...
        {
            this.heap = new List<HeapNode<K, V, P, K, V, P>>();
            this.priorityComparer = Comparer<P>.Default;
            this.placeHolder = new HeapNode<K, V, P, K, V, P>();
            this.heap.Add(new HeapNode<K, V, P, K, V, P>());
        }
        ...
        public void Enqueue(K key, V value, P priority)
        {
            ...
            this.heap[num] = new HeapNode<K, V, P, K, V, P>(key, value, priority);
