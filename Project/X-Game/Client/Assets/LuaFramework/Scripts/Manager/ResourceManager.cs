...
namespace LuaFramework
{
    ...
    public class ResourceManager : Manager
    {
        ...
        public void LoadPrefabFromResources(string resPath, Action<UObject> func)
        {
            if (!string.IsNullOrEmpty(resPath))
            {
                UObject prefab = Resources.Load(resPath) as UObject;
                if (prefab != null)
                {
                    if (func != null)
                    {
                    ...
                    {
                        Debug.LogWarning("load prefab from " + resPath + "failed");
                    }
                }
            }
            else
            {
                Debug.LogWarning("resPath is null");
            }
        }
