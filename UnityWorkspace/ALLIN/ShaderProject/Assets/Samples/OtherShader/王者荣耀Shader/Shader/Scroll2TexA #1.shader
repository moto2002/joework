Shader "S_Game_Effects/Scroll2TexA" {
Properties {
...
void main ()
{
  ...
  highp vec2 tmpvar_4;
  tmpvar_4 = vec2((tmpvar_3.x * _UVXX.x));
  uv_1 = tmpvar_4;
  highp vec2 P_5;
  P_5 = (xlv_TEXCOORD0.zw + uv_1);
  o_2.xyz = (tmpvar_3 + (texture2D (_MainTex2, P_5) * xlv_TEXCOORD1)).xyz;
  o_2.w = 1.0;
  gl_FragData[0] = o_2;
}
...
void main ()
{
  ...
  highp vec2 P_5;
  P_5 = (xlv_TEXCOORD0.zw + uv_1);
  o_2.xyz = (tmpvar_3 + (texture (_MainTex2, P_5) * xlv_TEXCOORD1)).xyz;
  o_2.w = 1.0;
  _glesFragData[0] = o_2;
}
