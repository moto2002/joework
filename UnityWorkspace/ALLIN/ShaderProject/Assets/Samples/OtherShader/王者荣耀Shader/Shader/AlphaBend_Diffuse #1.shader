Shader "S_Game_Scene/Light/AlphaBend_Diffuse" {
Properties {
...
Program "vp" {
SubProgram "gles " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "LIGHTMAP_ON" "DIRLIGHTMAP_OFF" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "LIGHTMAP_ON" "DIRLIGHTMAP_ON" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "VERTEXLIGHT_ON" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "LIGHTMAP_ON" "DIRLIGHTMAP_OFF" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
...
void main ()
{
  ...
  lowp vec4 tmpvar_3;
  tmpvar_3 = (tmpvar_2 * _Color);
  c_1.xyz = (tmpvar_3.xyz * (2.0 * texture (unity_Lightmap, xlv_TEXCOORD1).xyz));
  c_1.w = tmpvar_3.w;
  _glesFragData[0] = c_1;
}
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "LIGHTMAP_ON" "DIRLIGHTMAP_ON" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" "VERTEXLIGHT_ON" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
...
Program "vp" {
SubProgram "gles " {
Keywords { "POINT" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "SPOT" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "POINT_COOKIE" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "DIRECTIONAL_COOKIE" "_SEPERATE_ALPHA_TEX_OFF" }
"!!GLES
...
SubProgram "gles " {
Keywords { "POINT" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
...
void main ()
{
  ...
  lowp vec4 c_8;
  c_8.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * texture2D (_LightTexture0, vec2(tmpvar_7)).w) * 2.0));
  c_8.w = tmpvar_5;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_5;
  gl_FragData[0] = c_1;
...
SubProgram "gles " {
Keywords { "DIRECTIONAL" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "SPOT" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
...
void main ()
{
  ...
  atten_9 = ((float(
    (xlv_TEXCOORD3.z > 0.0)
  ) * texture2D (_LightTexture0, P_7).w) * texture2D (_LightTextureB0, vec2(tmpvar_8)).w);
  lowp vec4 c_10;
...
void main ()
{
  ...
  atten_9 = ((float(
    (xlv_TEXCOORD3.z > 0.0)
  ) * texture (_LightTexture0, P_7).w) * texture (_LightTextureB0, vec2(tmpvar_8)).w);
  lowp vec4 c_10;
  c_10.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * atten_9) * 2.0));
...
SubProgram "gles " {
Keywords { "POINT_COOKIE" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
...
void main ()
{
  ...
  c_8.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * 
    (texture2D (_LightTextureB0, vec2(tmpvar_7)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)
  ) * 2.0));
  c_8.w = tmpvar_5;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_5;
...
void main ()
{
  ...
  c_8.xyz = ((tmpvar_4.xyz * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD1, lightDir_2))
   * 
    (texture (_LightTextureB0, vec2(tmpvar_7)).w * texture (_LightTexture0, xlv_TEXCOORD3).w)
  ) * 2.0));
  c_8.w = tmpvar_5;
  c_1.xyz = c_8.xyz;
  c_1.w = tmpvar_5;
...
SubProgram "gles " {
Keywords { "DIRECTIONAL_COOKIE" "_SEPERATE_ALPHA_TEX_ON" }
"!!GLES
